...
def get_dashboard_stats():
    try:
        ...
        return jsonify({
            'code': 500,
            'message': 'Internal server error; unable to retrieve dashboard statistics',
            'data': None
        }), 500
...
def get_generated_posts():
    try:
        ...
        logger.error(f"Error retrieving generated posts: {str(e)}", exc_info=True)
        return jsonify({
            'code': 500,
            'message': 'Internal server error; unable to retrieve posts',
            'data': None
        }), 500
...
def get_scheduled_posts():
    try:
        ...
        logger.error(f"Error retrieving scheduled posts: {str(e)}", exc_info=True)
        return jsonify({
            'code': 500,
            'message': 'Internal server error; unable to retrieve scheduled posts',
            'data': None
        }), 500
...
def get_logs():
    try:
        ...
        return jsonify({
            'code': 500,
            'message': 'Internal server error; unable to retrieve logs',
            'data': None
        }), 500
